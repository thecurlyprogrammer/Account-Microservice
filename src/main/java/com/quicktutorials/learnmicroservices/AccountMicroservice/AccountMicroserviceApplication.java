...
public class AccountMicroserviceApplication implements CommandLineRunner {
	...
	// Operazioni di autowired, vado ad iniettare
	// UserDao, AccountDao e OperationDao
	// spring inietterà le classi concrete che implementano le interfacce
	// Senza @Autowired -> OperationDao operationDao = new OperationDao();
	@Autowired
	UserDao userDao;
	...
	public void run(String... strings) throws Exception {
		...
		// In UserDao non c'è il metodo save, il metodo save è uno dei metodi di JpaRepository
		// I dati vengono salvati in H2, database in memoria, viene creato nel run e distrutto allo stop
	...
	// Istanziazione di un bean che verrà usato in un altro bean
	@Bean
